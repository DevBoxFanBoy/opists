...
func NewIssuesApiService() v1.IssuesApiServicer {
	return &IssuesApiService{}
}

// AddIssue - Add a new issue to the tracking system
func (s *IssuesApiService) AddIssue(projectKey string, body model.Issue) (interface{}, error) {
...
func (s *IssuesApiService) DeleteIssue(projectKey string, id int64) (interface{}, error) {
...
func (s *IssuesApiService) GetIssueById(projectKey string, id int64) (interface{}, error) {
...
func (s *IssuesApiService) GetProjectIssues(projectKey string) (interface{}, error) {
...
func (s *IssuesApiService) UpdateIssue(projectKey string, body model.Issue) (interface{}, error) {
