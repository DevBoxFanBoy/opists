...
func (s *IssuesApiService) AddIssue(projectKey string, body Issue) (interface{}, error) {
...
func (s *IssuesApiService) UpdateIssue(projectKey string, body Issue) (interface{}, error) {
